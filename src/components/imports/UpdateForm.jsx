            ...
            <div className="container">
                <div className="box-nav d-flex-justify-between">
                    <div className="filter">
                        <Link to="/" className="fas text-blue fa-angle-double-left text-light">Tous les utilisateurs</Link>
                    </div>
                </div>
                <div className="form-title text-center">
                    <h2 className="text-light">Mettre à jour les données utilisateur</h2>
                    <span className="text-light">Utilisez le formulaire ci-dessous pour mettre à jour les données de cet utilisateur</span>
                </div>

                <form method="POST" id="update_user" onSubmit={handleSubmit}>
                    <div className="new_user">
                        <div className="form-group">
                            <label htmlFor="Name" className="text-light">Nom Complet</label>
                        ...
                        <div className="form-group">
                            <label htmlFor="gender" className="text-light">Sexe</label>
                            <div className="radio inline">
                                <input type="radio" id="radio-2" onChange={(e) => setGender(e.target.value)} name="gender" value="Male" />
                                <label htmlFor="radio-2" className="radio-label text-light">Homme</label>
                            </div>
                            <div className="radio inline">
                                <input type="radio" id="radio-3" onChange={(e) => setGender(e.target.value)} name="gender" value="Female" />
                                <label htmlFor="radio-3" className="radio-label text-light">Femme</label>
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="radio inline">
                                ...
                                <label htmlFor="radio-4" className="radio-label text-light">Actif</label>
                            </div>
                            <div className="radio inline">
                                <input type="radio" id="radio-5" name="status" value="Inactive" onChange={e => setStatus(e.target.value)} />
                                <label htmlFor="radio-5" className="radio-label text-light">Inactif</label>
                            </div>
                        </div>
                        {
